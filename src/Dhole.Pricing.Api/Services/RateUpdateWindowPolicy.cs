...
/// <summary>
/// Regla única para determinar cuándo una tarifa todavía puede ser actualizada.
/// Se permite modificar la misma solicitud mientras Pricing no la haya enviado y,
/// después del envío, únicamente mientras la tarifa permanezca en estado Sent.
/// </summary>
public static class RateUpdateWindowPolicy
{
        ...
        bool requestStillOpen)
    {
        ...
        {
            return new RateUpdateWindowDecision(
                false,
                null,
