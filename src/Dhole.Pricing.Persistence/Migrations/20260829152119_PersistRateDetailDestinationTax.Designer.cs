...
namespace Dhole.Pricing.Persistence.Migrations
{
    ...
    [Migration("20260829152119_PersistRateDetailDestinationTax")]
    partial class PersistRateDetailDestinationTax
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dhole.Pricing.Domain.Costs.Entities.CostService", b =>
                {
                    b.Property<Guid>("CostId")
                        .HasColumnType("uuid")
                        .HasColumnName("cost_id");
                    ...
                    b.HasKey("CostId", "ServiceId");

                    b.HasIndex("ServiceCode");

                    b.HasIndex("ServiceId");

                    b.ToTable("CostServices", "pricing");
                });
            ...
            modelBuilder.Entity("Dhole.Pricing.Domain.News.Entities.LogisticsNews", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("AppliedRateCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MatchedRateCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SourceOffice")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.ToTable("LogisticsNews", "pricing");
                });

            modelBuilder.Entity("Dhole.Pricing.Domain.News.Entities.LogisticsNewsRateImpact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AppliedComment")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<Guid>("ImportFclRateId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("LogisticsNewsId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ImportFclRateId");

                    b.HasIndex("LogisticsNewsId", "ImportFclRateId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Dhole.Pricing.Domain.Rates.Entities.RateDetail", b =>
                {
                    ...
                    b.Property<bool>("ApplyDestinationTax")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<decimal>("DestinationTaxRate")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("Dhole.Pricing.Domain.Rates.Entities.RateHeader", b =>
                {
                    ...
                    b.Property<decimal>("TotalCostCrc")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("total_cost_crc");
                    ...
                    b.Property<decimal>("TotalSaleCrc")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("total_sale_crc");

                    b.Property<decimal>("TotalSaleUsd")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("total_sale_usd");
                    ...
                    b.Property<decimal>("TotalUtilityCrc")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("total_utility_crc");

                    b.Property<decimal>("TotalUtilityUsd")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("total_utility_usd");
            ...
            modelBuilder.Entity("Dhole.Pricing.Domain.Rates.Entities.RateRevision", b =>
                {
                    ...
                    b.HasIndex("RateHeaderId", "RevisionNumber")
                        .IsUnique()
                        .HasDatabaseName("ux_rate_revisions_header_number");

                    b.ToTable("RateRevisions", "pricing");
                });

            modelBuilder.Entity("Dhole.Pricing.Domain.Rates.Entities.RateService", b =>
                {
                    b.Property<Guid>("RateHeaderId")
                        .HasColumnType("uuid")
                        .HasColumnName("rate_header_id");
                    ...
                    b.HasKey("RateHeaderId", "ServiceId");

                    b.HasIndex("ServiceCode");

                    b.HasIndex("ServiceId");

                    b.ToTable("RateServices", "pricing");
                });
            ...
            modelBuilder.Entity("Dhole.Pricing.Domain.Rates.Entities.RateService", b =>
                {
                    b.HasOne("Dhole.Pricing.Domain.Rates.Entities.RateHeader", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_rate_service_rate_headers_rate_header_id");
                });
